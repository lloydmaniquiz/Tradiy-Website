      ...
      <div className="signup-container">
        <div className="signup-wrapper">
          <div className="signup-image-section">
            <img src={Drilling} alt="Worker with drill" className="signup-image" />
          </div>
          ...
          <div className="signup-form-section">
            ...
            <div className="signup-role-selection">
              <button className={role === "Homeowner" ? "signup-active" : ""} onClick={() => setRole("Homeowner")}>
                Homeowner
              </button>
              <button className={role === "Tradiy Trader" ? "signup-active" : ""} onClick={() => setRole("Tradiy Trader")}>
                Tradiy Trader
              </button>
            </div>
            ...
            <div className="signup-input-group">
              ...
              />
              <button type="button" className="signup-icon-button" onClick={() => setPasswordVisible(!passwordVisible)}></button>
            ...
            <div className="signup-input-group">
              ...
              />
              <button type="button" className="signup-icon-button" onClick={() => setConfirmPasswordVisible(!confirmPasswordVisible)}></button>
              {confirmPasswordTouched && confirmPassword.trim() === "" && (
                <p className="error-message">Confirm Password should not be blank.</p>
              )}
            </div>
            ...
            <button 
              ...
              disabled={!Object.values(passwordValid).every(Boolean) || !passwordMatch || email.trim() === ""}
