      ...
      <div className="htw-how-tradiy-works">
        ...
        <section className="htw-content">
          ...
          <p className="htw-subheading">
            <strong>
              Discover how Tradiy makes hiring trusted professionals in your area simple and stress-free.
            </strong>
          </p>
          ...
          <div className="htw-steps-container">
            <div className="htw-step">
              ...
              <p>
                Create a free account, upload your ID for security, and unlock features like requesting quotes.
              </p>
            </div>
            ...
            <div className="htw-step">
              ...
              <p>
                Search by trade, location, and reviews. Bookmark profiles, compare quotes, and review qualifications and past work.
              </p>
            </div>
            ...
            <div className="htw-step">
              ...
              <p>
                Post job details, receive quotes, and hire the best match. After the job, leave a review to help others.
              </p>
            </div>
          </div>
          ...
          <div className="htw-cta">
            <button className="htw-search-button" onClick={searchATrade}>Search for a Trade</button>
          </div>
        </section>
        ...
        <div className="htw-personal-dashboard">
            <div className="htw-text-wrapper">
                <div className="htw-dashboard-header">
                    ...
                    <p>The Tradiy app will include a user-friendly dashboard to keep all your project details in one place. You’ll be able to:</p>
                </div>
                <div className="htw-check-text-container">
                    <div className="htw-check-text-wrapper">
                        ...
                        <p>Manage multiple projects at once with clear timelines and progress tracking.</p>
                    </div>
                    <div className="htw-check-text-wrapper">
                        <img src={BlueCheck} alt="blue-check" className="htw-check" />
                        <p>Receive push notifications for new quotes, updates, and deadlines.</p>
                    </div>
                    <div className="htw-check-text-wrapper">
                        <img src={BlueCheck} alt="blue-check" className="htw-check" />
                        <p>Communicate directly with tradespeople through built-in messaging.</p>
                    </div>
                </div>
            </div>
            <img src={CoffeeLaptop} alt="coffee-laptop" className="htw-side-image" />
        </div>

        {/* HTW Divider */}
        <div className="htw-divider">
          <div className="htw-overlay">
            <h2>This dashboard is designed to give you full control over your projects, saving you time and keeping everything organised.</h2>
          </div>
        </div>
        ...
        <div className="htw-homeowner-resource">
            <div className="htw-homeowner-header">
                ...
                <p>We’re here to help you make informed decisions about your home projects. Explore tips, insights, and advice tailored for homeowners:</p>
            </div>
            ...
            <div>
                <button className="htw-search-button" onClick={exploreMore}>Explore More</button>
            </div>
        ...
        <div className="htw-choose-tradiy-container">
            ...
            <div>
                <p>Tradiy offers homeowners a reliable way to find and hire trusted tradespeople, with benefits including:</p>
            </div>
            ...
            <div className="benefits-wrapper">
                ...
                <h3>Free to Use</h3>
                <p>
                    Browse, bookmark, and request quotes at no cost.
                </p>
                </div>
                <div className="htw-benefits-set">
                ...
                <p>
                    Connect with trusted tradespeople near you.
                </p>
                </div>
                <div className="htw-benefits-set">
                ...
                <p>
                    Help local tradespeople grow by hiring and leaving reviews.
                </p>
                </div>
            </div>
            ...
            <div className="htw-overlay-container">
                ...
                <div className="htw-overlay-coming-soon">
                    <div className="htw-overlay-text">
                        <h2>Ready to Join?</h2>
                        <p>Find and connect with verified professionals to bring your next project to life.</p>
                        <div>
                            <button className="htw-search-button" onClick={readyToJoin}>Explore More</button>
                        </div>
                    </div>
                </div>
            </div>
